 ...
 */
function _civicrm_api3_anoncheckin_Getparticipant_spec(&$spec) {
  $spec['magicword']['api.required'] = 1;
}

/**
 * Anoncheckin.Getparticipant API
 *
 * @param array $params
 *
 * @return array
 ...
 */
function civicrm_api3_anoncheckin_Getparticipant($params) {
  if (array_key_exists('magicword', $params) && $params['magicword'] == 'sesame') {
    ...
    return civicrm_api3_create_success($returnValues, $params, 'Anoncheckin', 'Getparticipant');
  }
  else {
